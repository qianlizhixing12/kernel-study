...
| 周次      | 状态   | 已完成内容                                                                 | 下一步                                                      |
| --------- | ------ | -------------------------------------------------------------------------- | ----------------------------------------------------------- |
| 第1周     | 已完成 | 已完成内核编译、initramfs制作、QEMU启动、增量构建和验收问答                 | 保持实验基线，后续故障实验均能恢复到该版本                  |
| 第2周     | 已完成 | 已完成GDB启动断点、模块加载卸载、NULL pointer oops、三种定位和修复回归      | 保持内核、模块和符号文件匹配，进入第3周学习                 |
...
- [第2周：GDB、内核模块与oops定位](notes/week02.md)
- 第3～48周学习路线见本文“每周学习路线”
